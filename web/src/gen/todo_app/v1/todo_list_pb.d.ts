 ...
 */
export declare class AddDeadlineResponse extends Message<AddDeadlineResponse> {
  constructor(data?: PartialMessage<AddDeadlineResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "todo_app.v1.AddDeadlineResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AddDeadlineResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AddDeadlineResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AddDeadlineResponse;

  static equals(a: AddDeadlineResponse | PlainMessage<AddDeadlineResponse> | undefined, b: AddDeadlineResponse | PlainMessage<AddDeadlineResponse> | undefined): boolean;
}
